...
DOCUMENTATION = '''
---
module: genie_parse_command
author:  NIS-E
short_description: Module for using Genie PyATS to parse network CLI output.
description:
    - Module for using Genie PyATS to parse network CLI output. For available parsers check Genie Parsers List (https://pubhub.devnetcloud.com/media/genie-feature-browser/docs/#/parsers).
    - Disclaimer: Not every parsers from Genie work as intended.
options:
    device_name:
        description:
    ...
    device_os:
        description:
            - Device OS (IOS, IOSXE, ASA, NXOS, etc), please refer to Genie Parser List
        required: true
    cli_command:
        description:
...
from ansible.module_utils.genie_parse import parse
